    ...
    public partial class initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderOrganization", x => new { x.OrdersOrderId, x.OrganizationsOrganizationId });
                    table.ForeignKey(
                        name: "FK_OrderOrganization_Orders_OrdersOrderId",
                        column: x => x.OrdersOrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderOrganization_Organizations_OrganizationsOrganizationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderOrganization_OrganizationsOrganizationId",
