...
|----------|-------------|
| **[🚀 IIS Deployment Guide](DEPLOYMENT-IIS.md)** | **Complete guide for deploying to IIS with Azure Key Vault (RECOMMENDED)** |
...
| [Deployment Guide](docs/deployment.md) | General deployment patterns and Azure resource setup |
...
| [UI Modernization](UI-MODERNIZATION-SUMMARY.md) | UI patterns, component architecture, Blazor best practices |
| [UI Quick Start](UI-QUICK-START.md) | Get started with UI development |

**Archived Troubleshooting Documentation**: Historical debugging artifacts archived in `archive/troubleshooting-2025-11/` for reference.
